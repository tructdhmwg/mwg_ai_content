...
export function AppShell({ children, breadcrumb, contentClassName }: Props) {
  ...
  return (
    <div className="flex min-h-screen overflow-x-hidden bg-[#f0f2f5]">
      <Sidebar />
      <main className="ml-[var(--sidebar-width)] min-h-screen w-[calc(100%_-_var(--sidebar-width))] min-w-0 overflow-x-hidden">
